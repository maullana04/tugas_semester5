			...
			<tbody>
				...
				while($d = mysqli_fetch_array($data)){
					...
					<tr>
						...
						<td>
                        <form action="beli_produk.php" method="post">
    <input type="hidden" name="produk_id" value="ID_PRODUK_DI_SINI">
    <input type="hidden" name="harga_produk" value="100000"> <!-- Misalkan harga produk 100.000 -->
